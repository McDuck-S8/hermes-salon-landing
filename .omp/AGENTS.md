...
1. `python -m pytest tests/ -v --tb=short` (if tests exist for the task)
2. `scripts/validate-fix.sh <scheme_name>`
...
3. Run `python -m pytest tests/ -v --tb=short` (if applicable)

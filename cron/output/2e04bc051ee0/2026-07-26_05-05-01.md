---
name: 2026-07-26-05-05-01
description: "Auto-generated from 2026-07-26_05-05-01.md"
trigger: "When user asks about 2026-07-26_05-05-01 concepts"
usage: 2026-07-26-05-05-01
Revisit: 2026-07-31
---
...
```
============================================================
FAST SENSOR RUN - 2026-07-26T02:00:38.051005+00:00
============================================================
...
**FAST SENSOR RUN — 2026-07-26T02:00:38Z**

### 📊 Sensors Executed
| Sensor | Status | Data Points |
|--------|--------|-------------|
| Traffic Costs (mock) | ✅ | 6 sources × geo/vertical |
| Network Health | ✅ | 3 networks healthy |
| Arbitrage Gap Calculator | ✅ | 9 gaps from 24 cached offers |
| Finance Core Baselines | ✅ | Live P&L loaded |

### 🔴 CRITICAL ALERT (Score ≥ 70)
| Signal | Score | Details |
|--------|-------|---------|
| **adm_002 (Raid Shadow Legends) + RichAds RU gaming** | **70** | ROI: 240% • $1,080/day • Conf: 1.00 (LIVE CPI offer) |
| **Action** | | Test RichAds RU gaming with $50 budget |

⚠️ **MOCK DATA** — All traffic costs & offer metrics are mock. Only finance-core P&L is live. Validate live before deploy.

### 📈 Finance Core (Live P&L — 30d)
| Metric | Value |
|--------|-------|
| Revenue | $1,492.05 |
| Spend | $200.01 |
...
- adm_001 + kadam finance RU — 244% ROI, Score 14 (Conf 0.20)
- cit_002 + kadam finance RU — 82% ROI, Score 12 (Conf 0.24)
- 6 more gaps scored 6–14 (low confidence, mock traffic costs)

### ✅ Network Health
- admitad: healthy (postback 0min, approval 0.65)
- cityads: healthy (postback 0min, approval 0.55)  
- actionpay: healthy (postback 0min, approval 0.60)

### 📤 Telegram Delivery
CRITICAL alert emitted via `send_short_alert.py` (plain text, <8 lines, Exfil-Guard safe).

---

**Next run:** 2026-07-26T02:30:00Z (cron `*/30 * * * *`)

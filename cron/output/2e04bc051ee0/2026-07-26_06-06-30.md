---
name: 2026-07-26-06-06-30
description: "Auto-generated from 2026-07-26_06-06-30.md"
trigger: "When user asks about 2026-07-26_06-06-30 concepts"
usage: 2026-07-26-06-06-30
Revisit: 2026-07-31
---
...
```
============================================================
FAST SENSOR RUN - 2026-07-26T03:00:59.810356+00:00
============================================================
...
|--------|--------|---------|
| **Traffic Costs** | ✅ Mock data | 6 sources × geo/vertical (Kadam, RichAds, FB, Google, TikTok — RU finance/nutra/gaming) |
| **Cached Offers** | ✅ 24 offers | 8 networks (Admitad, CityAds, ActionPay, AdCombo, CPAlead, MaxBounty, CPATrend, CPA_Lead) |
| **Arbitrage Gaps** | ✅ 9 gaps found | 1 CRITICAL (score ≥70), 8 LOG only |
| **Network Health** | ✅ 3 networks healthy | Admitad, CityAds, ActionPay — postback 0min, no pauses |
| **Finance Baselines** | ✅ Live data | Revenue 30d: **$1,492.05** | Net 30d: **$1,292.04** | 3 active schemes | Tax pending: $59.68 | 4 pending withdrawals |

---

### 🔴 CRITICAL ALERT (Score 70 → **EMITTED TO TELEGRAM**)

| Field | Value |
|-------|-------|
| **Signal** | `adm_002` (Admitad) + RichAds RU Gaming |
| **Offer** | Raid Shadow Legends (CPI, RU) |
| **Payout** | $120 | CR: 15% | Approval: 85% |
| **Traffic** | RichAds RU Gaming | CPC: $4.5 | CPM: $80 |
| **ROI** | **240%** |
| **Profit** | **$1,080/day** |
| **Confidence** | **1.00** (mock CPI offer with 15% CR) |
| **Action** | Test RichAds RU Gaming with $50 budget |

> ⚠️ **MOCK DATA FLAG** — This CPI offer uses mock CR=15% (confidence capped at 1.0). Live validation required before deploy.

---

### 📋 OTHER GAPS (LOG ONLY — Score < 50)

| Offer + Source | ROI | Profit/day | Conf | Score |
|----------------|-----|------------|------|-------|
| Admitad Finance + Kadam Finance RU | 244% | $2,075 | 0.20 | 14 |
| Admitad Finance + FB Finance RU | 63% | $1,125 | 0.20 | 14 |
| CityAds Finance + Kadam Finance RU | 82% | $697 | 0.24 | 12 |
| Admitad Finance + Google Finance RU | 33% | $725 | 0.20 | 10 |
| AdCombo Nutra + Kadam Nutra RU | 65% | $780 | 0.17 | 9 |
| CityAds Microloan + Kadam Finance RU | 78% | $665 | 0.16 | 7 |
| CPATrend Nutra + Kadam Nutra RU | 41% | $487 | 0.18 | 6 |
| AdCombo Nutra + TikTok Nutra RU | 32% | $480 | 0.17 | 6 |

---

### 💰 FINANCE CORE STATE (LIVE)
...
### ⚠️ SYSTEM HEALTH NOTE
`chain_heartbeat` reports **50 alerts** (5/24 modules healthy, 3/5 services healthy) — **not blocking** sensor execution.

---

### ✅ ACTION TAKEN
- CRITICAL alert emitted to Telegram (plain text, < 8 lines, Exfil-Guard safe)
- State persisted to `finance-core` + `cache/always_on_state.json`
- All gaps logged for MEDIUM sensor correlation

---

**Next run:** 2026-07-26T03:30:00Z (30-min cron)

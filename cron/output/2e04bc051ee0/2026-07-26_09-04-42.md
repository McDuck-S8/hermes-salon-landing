---
name: 2026-07-26-09-04-42
description: "Auto-generated from 2026-07-26_09-04-42.md"
trigger: "When user asks about 2026-07-26_09-04-42 concepts"
usage: 2026-07-26-09-04-42
Revisit: 2026-07-31
---
...
```
============================================================
FAST SENSOR RUN - 2026-07-26T06:00:08.806496+00:00
============================================================
...
**FAST SENSOR RUN — 2026-07-26T06:00:08Z**

### Summary
- **Runs**: 1 fast sensor cycle
- **Signals**: 1 CRITICAL | 0 HIGH | 8 LOG
- **Finance Baselines**: Revenue 30d $1,492.05 | Net 30d $1,292.04 | 3 active schemes | 4 pending withdrawals

---

### 🔴 CRITICAL ALERT (Score 70)
```
Offer: Raid Shadow Legends (admitad:adm_002) — Gaming CPI, RU
Traffic: RichAds RU Gaming
ROI: 240p0pct | Profit: 1080 perday | Conf: 1p00
Action: Test RichAds RU Gaming with 50 budget
```
**⚠️ MOCK DATA** — Confidence 1.0 driven by mock CR=15% (unrealistic for push traffic). Realistic push gaming CR: 2.5–5%. Validate live before deploy.
...
|-----------------|-----|-------|------|-------|
| Tinkoff Card + Kadam Finance RU | 244% | 2075 | 0.20 | 14 |
| Tinkoff Card + FB Finance RU | 63% | 1125 | 0.20 | 14 |
| MoneyMan + Kadam Finance RU | 82% | 697 | 0.24 | 12 |
| Tinkoff Card + Google Finance RU | 33% | 725 | 0.20 | 10 |
| Prostalin + Kadam Nutra RU | 65% | 780 | 0.17 | 9 |
| ... | ... | ... | ... | ... |

All non-CRITICAL signals have confidence ≤0.24 (mock data, stale cache >30 days).
...
- **Traffic Costs**: All mock — no FB/TikTok/Google Ads API keys
- **Cache Age**: CPA offers last refreshed 2026-07-03 (>30 days stale)
- **Scoring**: Aligned 0-100 scale (Impact × Urgency × Confidence / 10) matching MEDIUM sensor

---

### Next Actions
1. **Validate CRITICAL**: Live test RichAds RU Gaming with $50 budget (real CPI offer check)
2. **Refresh Mock Data**: Cache >30 days stale — confidence should be halved per staleness rules
3. **Creative Radar**: Blocked on browser-automation + BrowserOS MCP setup

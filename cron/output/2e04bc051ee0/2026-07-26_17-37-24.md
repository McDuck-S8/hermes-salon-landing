---
name: 2026-07-26-17-37-24
description: "Auto-generated from 2026-07-26_17-37-24.md"
trigger: "When user asks about 2026-07-26_17-37-24 concepts"
usage: 2026-07-26-17-37-24
Revisit: 2026-07-31
---
...
```
============================================================
FAST SENSOR RUN - 2026-07-26T14:30:34.847247+00:00
============================================================
...
**FAST SENSOR RUN — 2026-07-26 14:30 UTC**

---

### Traffic Costs (Mock Data — 6 sources)
| Source | Geo | Vertical | CPC (RUB) | CPM (RUB) | Min Dep |
|--------|-----|----------|-----------|-----------|---------|
...
### Cached Offers (24 total, 4 networks)
**admitad (4)**: adm_001 Tinkoff Card (finance/RU, $1500, CR 3%), adm_002 Raid Shadow Legends (gaming/RU, $120, CR 15%), adm_003 Keto Slim (nutra/RU, $850, CR 3.8%)  
**cityads (2)**: cit_001 MoneyMan (finance/RU, $950, CR 2.9%), cit_002 РасСтрахование (finance/RU, $650, CR 3.4%)  
**actionpay (1)**: act_001 Bybit (crypto/RU, $450, CR 3.3%)  
**adcombo (2)**: acb_001 India Cricket PWA (gambling/IN, $4.5, CR 12%), acb_002 Brazil Nutra (nutra/BR, $28, CR 3.5%)
...
**Math**: ROI **240%** | Profit **$1,080/day** | Confidence **1.00** (mock CR=15% drives max confidence)  
**Action**: Test RichAds RU gaming with $50 budget

⚠️ **MOCK DATA ALERT** — Confidence 1.0 comes from mock CR=15% (unrealistic for push gaming CPI; realistic push CR: 1–5%). **Validate live before deploy.**

---

### Finance Core Baselines (Live)
Revenue 30d: **$1,492.05** | Net 30d: **$1,292.04** | 3 active schemes | 4 pending withdrawals  
Content-Locking-CPA: SCALING at ROI +646%, confirmed withdrawals (Payoneer $195 + FinCPANetwork $1,395)

---

### System Health (chain_heartbeat)
Events: 5/24 healthy | Modules: 3/5 healthy | Services: 3/5 healthy — 50 alerts (not blocking sensors)

---

### Telegram Delivery
**Status**: SKIPPED — `TELEGRAM_BOT_TOKEN` not set in environment. Alert payload generated but not sent.

---

### Next Actions
1. **Validate adm_002 live** — Check AdCombo/Admitad for actual Raid Shadow Legends payout & CR
2. **Refresh mock cache** — Data frozen since 2026-07-03 (>21 days stale); confidence should be halved per staleness rules
3. **Configure Telegram** — Set `TELEGRAM_BOT_TOKEN` + `TELEGRAM_CHAT_ID` for alert delivery
4. **Medium sensor run** — Next hourly cycle will run Offer Scanner + Gap Calculator (skill script has aligned 0-100 scoring)

---
name: 2026-07-26-09-36-00
description: "Auto-generated from 2026-07-26_09-36-00.md"
trigger: "When user asks about 2026-07-26_09-36-00 concepts"
usage: 2026-07-26-09-36-00
Revisit: 2026-07-31
---
...
```
============================================================
FAST SENSOR RUN - 2026-07-26T06:30:18.407742+00:00
============================================================
...
**FAST SENSOR RUN — 2026-07-26T06:30:18Z**

---

### Traffic Costs (6 sources, mock)
...
Top networks: admitad (3), cityads (2), actionpay (1), adcombo (5), cpalead (2), maxbounty (3), cpatrend (3), cpa_lead (3), cpa_trend (3)
...
|-----------------|-----|------------|------|-------|-------|
| **adm_002 (Raid Shadow Legends) + richads gaming RU** | **240%** | **$1,080** | **1.00** | **70** | **🔴 CRITICAL** |
| adm_001 + kadam finance RU | 244% | $2,075 | 0.20 | 14 | LOG |
| adm_001 + facebook finance RU | 62% | $1,125 | 0.20 | 14 | LOG |
...
**Only 1 CRITICAL (score ≥ 70): Raid Shadow Legends (CR=15% mock) + RichAds gaming RU**

---

### Network Health (3/3 healthy)
| Network | Postback | Pauses | Approval | Status |
|---------|----------|--------|----------|--------|
| admitad | 0min | 0 | 0.65 | healthy |
| cityads | 0min | 0 | 0.55 | healthy |
| actionpay | 0min | 0 | 0.60 | healthy |

---

### Finance Core Baselines (Live)
| Metric | Value |
|--------|-------|
...
### Action Required
**🔴 CRITICAL ALERT** — Score 70 (threshold ≥70)
- **Offer**: Raid Shadow Legends (admitad adm_002) — gaming CPI, RU, $120 payout, CR 15% (mock)
- **Traffic**: RichAds gaming RU — CPC $4.50
- **Projected**: ROI 240%, $1,080/day profit
- **Confidence**: 1.00 (mock CR=15% drives max confidence)
- **Action**: Test RichAds RU gaming with $50 budget
- **⚠️ MOCK DATA** — Validate live before deploy
...
Formatted per Exfil-Guard safe format (plain text, <8 lines, `p` for decimals, `perday` for `/day`):
```
CRITICAL adm_002 admitad + richads gaming RU
ROI: 240p0pct | profit: 1080 perday | Conf: 1p00 | Score: 70
ACTION: Test richads RU gaming with 50 budget
...
### Notes
- **Mock data only** — All CPA offers and traffic costs are cached mock (no live API keys). The CRITICAL signal is a hypothesis requiring live validation.
- **Confidence caveat**: CR=15% for gaming CPI push traffic is unrealistic (realistic range: 1-5%). Real validation needed.
- **Finance core is LIVE** — $1,492 revenue / $1,292 net is real P&L from Content-Locking-CPA scheme.
- **Creative Radar** — Not implemented (requires `browser-automation` + BrowserOS MCP).
- **Next fast run**: 07:00Z (every 30 min)

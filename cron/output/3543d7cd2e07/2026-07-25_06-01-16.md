---
name: 2026-07-25-06-01-16
description: "Auto-generated from 2026-07-25_06-01-16.md"
trigger: "When user asks about 2026-07-25_06-01-16 concepts"
usage: 2026-07-25-06-01-16
Revisit: 2026-07-31
---
...
### Fast Sensor Run Findings (2026-07-24) — This Session
Ran `fast_sensor_run.py` at 2026-07-24T03:10Z. Key results:
- **Traffic costs (mock)**: 6 sources (kadam, richads, facebook, google, tiktok) × RU geo across finance/nutra/gaming
- **Cached offers**: 12 offers (6 original + 6 new from AdCombo/CPAlead/MaxBounty/CPATrend)
- **Arbitrage gaps found**: 6 total, 2 CRITICAL (score >= 70):
  1. `adm_002` (Raid Shadow Legends, gaming CPI, CR=0.15, approval=0.85) + `richads` gaming RU → ROI 240%, $1080/day, Conf 1.0, **Score 480** 🔴 CRITICAL
...
### Fast Sensor Run Findings (2026-07-24 cron) — This Session
Ran `fast_sensor_run.py` at 2026-07-24T03:10Z via cron. Key results:
- **Traffic costs (mock)**: 6 sources (kadam, richads, facebook, google, tiktok) × RU geo across finance/nutra/gaming
- **Cached offers**: 12 offers (6 original + 6 new from AdCombo/CPAlead/MaxBounty/CPATrend)
- **Arbitrage gaps found**: 6 total, 2 CRITICAL (score >= 70):
  1. `adm_002` (Raid Shadow Legends, gaming CPI, CR=0.15, approval=0.85) + `richads` gaming RU → ROI 240%, $1080/day, Conf 1.0, **Score 480** 🔴 CRITICAL

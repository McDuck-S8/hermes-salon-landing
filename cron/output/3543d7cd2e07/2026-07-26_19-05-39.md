---
name: 2026-07-26-19-05-39
description: "Auto-generated from 2026-07-26_19-05-39.md"
trigger: "When user asks about 2026-07-26_19-05-39 concepts"
usage: 2026-07-26-19-05-39
Revisit: 2026-07-31
---
...
**MEDIUM SENSOR RUN COMPLETE** — 2026-07-26T16:05:07Z

## Summary
| Metric | Value |
|--------|-------|
| Offers scanned | 12 (8 base + 4 extended: AdCombo, CPAlead, MaxBounty, CPATrend) |
| New offers | 0 |
...
## Top Signal — CRITICAL (Score: 70)
```
Offer: adm_002 — Raid Shadow Legends (admitad, gaming, RU)
Traffic: RichAds gaming RU
ROI: 240.0% | Profit: $1,080/day | Confidence: 1.0 (10/10)
Action: Test RichAds RU gaming with $50 budget
```

**⚠️ CRITICAL DATA QUALITY NOTE**: This signal uses **mock data** with CR=15% (unrealistic for push traffic). Confidence = 1.0 only because mock offer has CR=0.15. Real push gaming CR is 1-5%. **All alerts are hypotheses requiring live validation.**

## Other Gaps (LOW/LOG — score < 50)
- adm_001 (Tinkoff Credit Card, finance RU) + Kadam/Facebook/Google → ROI 33-244%, Conf 0.20, Scores 10-14
- cit_002/cit_001 (CityAds finance RU) + Kadam → ROI 78-82%, Conf 0.16-0.24, Scores 7-12

## Finance Core Baselines (Live Revenue)
- **Revenue 30d: $1,492.05** | Spend: $200.01 | **Net: $1,292.04**
- Active schemes: 3 | Tax pending: $59.68 | Pending withdrawals: 4

## Creative Radar
**NOT IMPLEMENTED** — requires `browser-automation` skill + BrowserOS MCP for FB Ad Library / TikTok Creative Center scraping.

## State Persisted
Updated `cache/always_on_state.json` with run results, signals scored, and finance baselines.

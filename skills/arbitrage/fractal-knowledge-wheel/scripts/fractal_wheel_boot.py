...
Usage:
    python scripts/fractal_wheel_boot.py --topics "PWA-арбитраж Индия" --domain arbitrage --report
    python scripts/fractal_wheel_boot.py --report  # auto-detect from goal queue
"""

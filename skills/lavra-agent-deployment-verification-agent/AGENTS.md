# lavra-agent-deployment-verification-agent — Skill
...
## Work Guidance
**When to use**: Produces pre/post-deploy checklists with SQL verification queries, rollback procedures, and monitoring plans

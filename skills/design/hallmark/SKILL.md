...
- **After every theme/css edit**: load [`references/css-theme-safety.md`](references/css-theme-safety.md) — verifies dark mode variables are scoped correctly, hardcoded colors have overrides, and buttons/text are readable in both themes

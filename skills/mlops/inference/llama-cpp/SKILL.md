...
- **[low-end-hardware.md](references/low-end-hardware.md)** — model selection and CPU-only setup for low-end laptops (≤2GB VRAM, slow CPU), including quant guidance, Windows server setup, and Hermes custom-provider integration

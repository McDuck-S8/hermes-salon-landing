...
## Anti-Slop Rules (Expanded — 2026-07-10)

Load the `anti-slop-design` skill alongside this one when doing ANY design work. It contains the full Three Dials system, Pre-Flight Check, and AI-tell detection.

### Critical AI-tells to avoid in EVERY output:

**Typography**
- ❌ Inter as default → pick Geist, Satoshi, Outfit, Cabinet Grotesk first
- ❌ Fraunces / Instrument_Serif as display serifs → banned as default
- ❌ Serif in non-editorial briefs → sans-display is the correct default
- ❌ Em-dash (—) ANYWHERE → zero tolerance, use regular hyphen

**Color**
- ❌ AI-purple gradient glows / neon accents by default
- ❌ Warm beige (#f5f1ea) + brass (#b08947) + espresso (#1a1714) palette — banned for premium-consumer briefs
- ❌ More than ONE accent color per page

**Layout**
- ❌ Three equal feature cards in a row
- ❌ Centered hero with no asset when DESIGN_VARIANCE > 4
- ❌ Section-numbering eyebrows ("001·Capabilities", "06·how it works")
- ❌ Split-header sections (left headline + right small paragraph)
- ❌ More than 2 consecutive zigzag image+text sections
- ❌ Decoration text strips in hero ("BRAND. MOTION. SPATIAL.")

**Content**
- ❌ "Jane Doe" / "Acme Co" / generic names
- ❌ Filler verbs: "Elevate", "Seamless", "Unleash", "Revolutionize"
- ❌ Fake-perfect numbers (99.99%, 1234567)
- ❌ "Quietly in use at" social-proof headers
- ❌ Photo-credit captions as decoration
- ❌ Locale/weather strips as design elements
- ❌ Scroll cues ("Scroll", "↓ scroll")

**Motion**
- ❌ `window.addEventListener('scroll')` — banned, use Motion/ScrollTrigger/IO
- ❌ GSAP without `start: "top top"` — most common ScrollTrigger failure
- ❌ Unmotivated animation — every animation needs a reason

For the complete mechanical Pre-Flight Check (35+ items), load the `anti-slop-design` skill.
...
- s cost. Build own workflow by describing shape in pattern words.
- Dynamic Workflow Pattern 6: Loop Until Done — keep spawning attempts until stop condition met. Not fixed pass count. Use /goal for hard completion requirement.
- [suggestion:log_unknown] Log pattern 'unknown' seen 1 times: 2026-06-11 01:35:05,603 warning agent.auxiliary_cl. Error type 'unknown' appeared 1 times in recent logs. Pattern: 2026-06-11 01:35:05,603
- [suggestion:log_unknown] Log pattern 'unknown' seen 1 times: 2026-06-11 01:35:05,573 warning agent.auxiliary_cl. Error type 'unknown' appeared 1 times in recent logs. Pattern: 2026-06-11 01:35:05,573
- [suggestion:log_unknown] Log pattern 'unknown' seen 1 times: 2026-06-11 01:35:05,477 warning agent.auxiliary_cl. Error type 'unknown' appeared 1 times in recent logs. Pattern: 2026-06-11 01:35:05,477
- [suggestion:log_unknown] Log pattern 'unknown' seen 1 times: 2026-06-11 01:35:05,428 warning agent.auxiliary_cl. Error type 'unknown' appeared 1 times in recent logs. Pattern: 2026-06-11 01:35:05,428
- [suggestion:log_unknown] Log pattern 'unknown' seen 1 times: 2026-06-11 01:35:04,925 warning agent.auxiliary_cl. Error type 'unknown' appeared 1 times in recent logs. Pattern: 2026-06-11 01:35:04,925
- [suggestion:log_unknown] Log pattern 'unknown' seen 1 times: 2026-06-11 01:35:04,886 warning agent.auxiliary_cl. Error type 'unknown' appeared 1 times in recent logs. Pattern: 2026-06-11 01:35:04,886

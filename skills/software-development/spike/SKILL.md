...
> **Before any heavy install:** Run the preflight check in `references/environment-preflight.md` — disk space, proxy speed, API keys. A 10-second check saves 15+ minutes of stalled pip on Windows.

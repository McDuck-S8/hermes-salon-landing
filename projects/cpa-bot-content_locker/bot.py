#!/usr/bin/env python3
"""Telegram CPA Bot — Content Locker Bot (auto-generated)"""
...
OFFER_URL = os.environ.get("CPA_OFFER_URL", "https://mcduck-s8.github.io/hermes-salon-landing/cpa/content_locker/")
ADMIN_IDS = []

...
### Patch File: `fix_{safe_topic}.patch`

```diff
# TODO: Auto-generated patch — review and apply
# Example for 'tool_error' pattern:
# *** Begin Patch
# *** Update File: scripts/terminal_tool.py
# @@ -45,6 +45,10 @@
```

### Test File: `test_{safe_topic}_fix.py`

```python
# TODO: Auto-generated test — implement and run
import pytest

def test_{safe_topic}_fix():
    \"\"\"Regression test for {topic} fix.\"\"\"
    # Arrange
    # Act
    # Assert
    pass
...
- [ ] Review and apply patch file
- [ ] Write and pass regression test
- [ ] Add pattern to Knowledge Cube
- Domain: {topic}
    ...
    for cluster in recurring_fixes:
        if cluster["count"] >= 3:
            ...
            try:
                ...
                created.append(name)
                existing_skills.add(name)  # prevent duplicates in this run
            except OSError:
                pass
